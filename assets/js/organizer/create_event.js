...
function createNewEvent() {
    ...
    let description = `<h1 class="text-brand fw-bold">Agenda</h1><div class="descQill">${descQuillContent}</div>`;
                ...
                <div class="agenda-card mb-3 border rounded-4 py-3 px-4">
                    ...
                    `agendaStarttime${i}`
                        ...
                        `agendaEndtime${i}`
                                                    ...
                                                    <h4 id="agenda-title">${document.getElementById(
                        `agendaTitle${i}`
                    ).value
                    }</h4>
                                                    <p id="agenda-desc" class="mb-0 ps-4">${document.getElementById(
                        `agendaDesc${i}`
                    ).value
                    }</p>
                                                </div>
